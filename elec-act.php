            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Electrical-Process Status</h1>
                        <ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="index.php">Overall Status</a></li>
                            <?php if(isset($_GET['act'])){?>
							<li class="breadcrumb-item"><a href="elec.php">Electrical-Process</a></li>
							...
							else echo "<li class='breadcrumb-item active'>Electrical-Process</a></li>";
							?>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Activity Status Table 
							<div class="btn-group" style="float:right;">
							<?php if(isset($_SESSION['section'])){if($_SESSION['section']=='elec-p'){?><button style="float:right;" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#form-modal">Update</button><?php }}?>
							<a class="btn btn-sm btn-outline-secondary" data-toggle="collapse" href="#logchartdiv" role="button" aria-expanded="false" aria-controls="collapseExample" style="float:right;">
							Show Progress
							</a>
							</div>
...
var myPieChart = new Chart(ctx, {
  type: 'pie',
  data: {
    labels: ["elec-p", "Elec-P", "Inst-P", "ISI", "Prod-P"],
    datasets: [{data: [ 
...
$("#save").click(function(){
	$.ajax({
        type:"GET",
        url: 'save.php?act=<?php echo $_GET['act'];?>&sec=elec-p',
