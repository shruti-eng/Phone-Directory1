  ...
  <main>
    <div class="container-fluid">
      ...
      <ol class="breadcrumb mb-4">
        ...
        <div class="card mb-4">
                <div class="card-header"><i class="fas fa-table mr-1"></i>All Emergency Contacts</div>
                <div class="card-body">
                    <div class="table-responsive table-hover">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php $query = $conn->query("SELECT * FROM `employee` WHERE `cat1`='14' or `cat2`='14' or `cat3` = '14'");
                                if (!$query) die($conn->error);
                                $x = 0;
                                while ($row = $query->fetch_assoc()) {
                                    echo"<tr>";
