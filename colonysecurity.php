...
<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid">
      <h1 class="mt-4">Colony Security</h1>
      <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
        <?php if (isset($_GET['act'])) { ?>
          <li class="breadcrumb-item"><a href="colonysecurity.php">Colony Security</a></li>
        ...
        <div class="card mb-4">
                <div class="card-header"><i class="fas fa-table mr-1"></i>Contacts - Colony Security</div>
                <div class="card-body">
                    <div class="table-responsive table-hover">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php $query = $conn->query("SELECT * FROM `employee` WHERE `cat1`= '44' or `cat2`='44' or `cat3` = '44'");
                                if (!$query) die($conn->error);
                                $x = 0;
                                while ($row = $query->fetch_assoc()) {
                                    echo"<tr>";
