                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
							...
							<?php if(isset($_SESSION['section'])){if($_SESSION['section']=='prod-p'){?><button style="float:right;" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#form-modal">Update</button><?php }}?>
...
var myPieChart = new Chart(ctx, {
  type: 'pie',
  data: {
    labels: ["prod-p", "prod-p", "prod-p", "ISI", "Prod-P"],
    datasets: [{data: [ 
...
$("#save").click(function(){
	$.ajax({
        type:"GET",
        url: 'save.php?act=<?php echo $_GET['act'];?>&sec=prod-p',
