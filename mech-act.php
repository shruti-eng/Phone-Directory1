            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Mechanical-Process Status</h1>
                        <ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="index.php">Overall Status</a></li>
                            <?php if(isset($_GET['act'])){?>
							<li class="breadcrumb-item"><a href="mech.php">Mechanical-Process</a></li>
                        ...
                        <div class="card mb-4">
							...
							<?php if(isset($_SESSION['section'])){if($_SESSION['section']=='mech-p'){?><button style="float:right;" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#form-modal">Update</button><?php }}?>  
...
$("#save").click(function(){
	$.ajax({
        type:"GET",
        url: 'save.php?act=<?php echo $_GET['act'];?>&sec=mech-p',
